<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="OfficeMesajAnother.aspx.cs" Inherits="HESCompany.OfficeMesajAnother" %>
    ...
    <table style="width:100%;">
         <tr>
            <td style="width:50%; text-align:right; ">
                  <asp:Button style="background-color:yellowgreen; color:white; margin:10px; font-size:15px; padding:10px 15px; border:none; border-radius:5px;" ID="Button8" runat="server" Text="Sohbeti Başlat" OnClick="Button3_Click" /></td>
