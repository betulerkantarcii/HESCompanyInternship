<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="StaffInfoExecutive.aspx.cs" Inherits="HESCompany.StaffInfoExecutive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView class="StaffInfoGridView" ID="GridViewStaffInfo" runat="server" AutoGenerateColumns="False" Width="90%"  BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" OnRowCommand="GridViewStaffInfo_RowCommand">
        <Columns>
            ...
            <asp:ButtonField ButtonType="Button" Text="Takvim">
            <ControlStyle CssClass="ButtonExecutiveDate" />
            </asp:ButtonField>
        </Columns>
    ...
    <asp:Panel ID="PanelTakvim" runat="server">

        <table style="width:90%; text-align:center;">
            <tr>
                <td style="width:10%;">
                    <asp:Button style="font-size:30px; font-weight:bold; border:none; background-color:#574c4f; color:#DDD"  ID="Button1" runat="server" Text="<" OnClick="Button1_Click" />  </td> <td style="width:80%; padding:30px 0;"> <asp:Label ID="Label3" style="font-size:30px; color:#DDD;" runat="server" Text="Giriş Çıkış Takvimi"></asp:Label> </td>
            </tr>
        </table>
