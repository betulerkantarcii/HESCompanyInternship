...
namespace HESCompany
{
    public partial class StaffInfo : System.Web.UI.Page
    {
        ...
        private void DataBagla()
        {
            ...
            string query = "Select EmployeeDepartment, EmployeeInfoTable.EmployeeID, EmployeeName, EmployeeMail, ExecutiveName, ExecutiveMail, EnterPersonel, ExitPersonel FROM EmployeeInfoTable, ExecutiveInfoTable, PersonelDateInfo WHERE  EmployeeInfoTable.EmployeeID = '"+ id +"' and  EmployeeInfoTable.ExecutiveID = ExecutiveInfoTable.ExecutiveID and EmployeeInfoTable.EmployeeID = PersonelDateInfo.EmployeeID and DatePersonel = '"+ date +"'; ";
        ...
        private void DataBaglaDate()
        {
            Connection con = new Connection();
            DataTable dt = new DataTable();
            dt = con.dataFillDate(year, month, id);
